...
namespace A1_200412952.Data.Migrations
{
    ...
    [Migration("20191010012849_fix of fix 2")]
    partial class fixoffix2
    {
            ...
            modelBuilder.Entity("A1_200412952.Models.PetFood", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = 2, AnimalId = 1, Brand = "PetFoods", Description = "It will last for 2 months", Name = "Bone", NutritionalInformation = "Just a bone", Price = 1m, Weight = 1f }
                    );
                });
